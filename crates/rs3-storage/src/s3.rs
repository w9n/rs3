...
#[path = "s3/object_lock.rs"]
mod object_lock;

use object_lock::{
    legal_hold_blocks_delete, legal_hold_from_s3_head, legal_hold_from_s3_legal_hold,
    provider_legal_hold, retain_until_date, retention_blocks_delete, retention_from_s3_head,
    retention_is_active, retention_mode_label, retention_satisfies, sdk_legal_hold_status,
    sdk_object_lock_mode, sdk_object_lock_retention_mode, verify_legal_hold, verify_retention,
};
