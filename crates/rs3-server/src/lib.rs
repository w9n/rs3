...
pub use admin::{
    ...
    AdminPostureReport, AdminProviderConformanceSummary, AdminProviderSummary, AdminReadiness,
    AdminReadinessSource, AdminReportProfile, AdminRepositoryRuntimeFacts, AdminRepositorySummary,
    AdminRestoreSummary, AdminRuntimeFacts, AdminRuntimeFactsSource, AdminRuntimeSummary,
    AdminSecuritySummary, AdminStatusReport, AdminV2CommitCoordinatorSummary,
    AdminV2MaintenanceSummary, AdminV2RestoreSummary, admin_posture_report,
