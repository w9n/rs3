...
pub use s3::{
    ...
    V2AnchorImportOptions, V2AnchorImportReport, V2PreparedRepositoryInit, V2ProbeObservation,
    ...
    check_v2_provider_conformance_from_provider_config, doctor_probe_from_config,
