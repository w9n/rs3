...
pub(super) async fn scrape_prometheus_metrics(authority: &str) -> Result<String> {
    let started = Instant::now();
    loop {
...
pub(super) fn prometheus_metrics_delta_json(before: &str, after: &str) -> Value {
...
pub(super) fn compare_runs(runs: &[Value]) -> Value {
