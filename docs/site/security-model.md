...
- Signed publication timestamps currently use local wall time without strict
  parent-relative enforcement on writing or replay. Chronology and clock/handoff
