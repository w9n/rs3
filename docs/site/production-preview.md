...
| Evidence | Result |
| --- | --- |
| Current v02 bounded-compaction scale lane | Revision `0c8ce72` passed three automatic-compaction release runs on 2026-07-12 with 1,000,000 512 B objects. Elapsed was 32.233-32.462 s, recovery was 5.106-5.188 s, and total reload was 5.148-5.230 s. Every run recorded 1,008 PUTs, 3,433 GETs, 806 HEADs, 1.459546533x write amplification, 233 active runs, peak RSS of 1,771,307,008-1,771,573,248 B including the in-memory backend, and one exact `GET` at 1.03125x per cold sentinel. |
| Current local fresh-process filesystem lane | Revision `647db90` passed three ext4 1M runs. Writer elapsed was 38.958-39.037 s and RSS was 914,804,736-915,202,048 B; fresh-reader recovery was 5.466-5.592 s, verification was 5.501-5.629 s, and RSS was 1,004,638,208-1,005,285,376 B. Every run recovered the exact million entries and 233 runs at 1.459497758x write amplification. These repository-process values exclude an in-memory backend; this is not pinned-runner timing, an HTTP gateway measurement, or provider qualification. |
