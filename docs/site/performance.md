...
The latest [bounded compaction comparison](#bounded-compaction-september-9-2026)
measures a small-write optimization against the previous gateway revision.
The [gateway versus direct S3 comparison](#gateway-versus-direct-s3-september-9-2026)
measures object-store traffic and retained bytes before that optimization.
Earlier results retain their original source bindings below.

## Bounded compaction: September 9, 2026
