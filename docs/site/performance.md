...
The 2026-05 measurements below predate the current index-run wire version 10
...
- Rerun known-length streamed uploads, post-checkpoint cold ranges,
  and mixed pack/stream compaction under wire version 10; report request, byte,
