...
| Kubernetes v2 Lease | `just integration-k8s-gateway` | Image build, kind cluster, Helm install, readiness and S3 smoke, including verification that v2 anchor annotations are written. |
