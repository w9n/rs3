...
This page preserves the dated measurement records that preceded the current
cost comparisons. Their revision bindings, sample values, failed budgets and
scope limits remain part of the evidence record. They do **not** qualify a
later release or establish external-provider performance.

For current RustFS cost measurements, method and limits, see
[Performance](../performance.md).

## September 8 and earlier records
